      ...
      <React.Fragment>
        <main className="container">
          ...
          <div class="column">
              ...
              <div font-size="18px">
                Here is my astrological yantra in two forms. These diagrams show the positions of the planets in the sidereal zodiac signs. Aries is at the top, and the signs proceed through Taurus, Gemini, and so on going counterclockwise.<br /><br />
